    ...
    <el-row style="margin-top:15px">
      ...
      <el-card shadow="hover">
        ...
        >
          ...
          <el-table-column property="ref_cstm_id" label="客户编号" align="center"></el-table-column>

          <el-table-column property="customer_name" label="客户名称" align="center"></el-table-column>
          ...
          <el-table-column property="creator_name" label="创建人" align="center"></el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="创建人">
              <el-input v-model="createServiceFormData.creator" :disabled="true" style="width:100%"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="概要">
              <el-input v-model="createServiceFormData.summary" style="width:100%"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    selectByPrimaryKey(selectKey) {
      ...
      }else if(this.selectKey.type == "客户名称"&&this.selectKey.value!=null){
        axios
        .get(Api.getAllserviceUrl,{
          params:
          {
