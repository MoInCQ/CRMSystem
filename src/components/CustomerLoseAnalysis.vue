    ...
    <el-row style="margin-top:15px">
      ...
      <el-card shadow="hover">
        ...
        >
          ...
          <el-table-column property="lost_time" label="时间" align="center"></el-table-column>
          ...
          <el-table-column property="measure_or_reason" label="流失原因" align="center"></el-table-column>
        </el-table>
      </el-card>
    </el-row>
  </div>
...
export default {
  ...
  mounted:function(){
    axios
        .get(Api.getAndUpdateCustomerLoseUrl)
        .then(res => {
